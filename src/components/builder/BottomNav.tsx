...
const styles = StyleSheet.create({
  ...
  icon: { color: builderColors.textVariant, fontSize: 18, marginBottom: 4 },
  label: { color: builderColors.textVariant, fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.5 },
  activeText: { color: builderColors.gold, fontWeight: '700' }
});
